...
import school.management.system.sms.email.EmailSender;
...
public class StudentRegistrationService {
    ...
    public String register(StudentRegistrationRequest registrationRequest) {
...
//        System.out.println("gvshshvshvsxvssagvasgvasgvasgsa");
        String token = studentService.studentSignUp(
                new Student(
        ...
        emailSender.sendEmail(registrationRequest.getEmail(), buildEmail(registrationRequest.getFirstName(), link));
